                                      ...
                                      child: SingleChildScrollView(
                                        ...
                                        child: ListView.builder(
                                          ...
                                          itemBuilder: (BuildContext context, x) {
                                            return InkWell(
                                              onTap: () {
                                                if ((homeController.variationList.every(
                                                  (item) =>
                                                      item.id !=
                                                      homeController
                                                          .itemDetailsData
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        InkWell(
                                                                          onTap: () {
                                                                            int
                                                                            i = addonList.indexWhere(
                                                                              (
                                                                                e,
                                                                              ) =>
                                                                                  e.id ==
                                                                                  homeController.itemDetailsData.value.addons![index].itemAddonId,
                                                                            );
                                                                            qty =
                                                                            ...
                                                                            if (qty >
                                                                              ...
                                                                              removeItemAddons(
                                                                                homeController.itemDetailsData.value.addons![index].itemAddonId,
                                                                                homeController.itemDetailsData.value.addons![index].itemId,
                                                                                homeController.itemDetailsData.value.addons![index].addonItemName,
                                                                                homeController.itemDetailsData.value.addons![index].addonItemConvertPrice.toString(),
                                                                                qty,
                                                                                homeController.itemDetailsData.value.addons![index].cover,
                                                                                i,
                                                                                homeController.itemDetailsData.value.addons![index].variationTotalConvertPrice.toString(),
                                                                                homeController.itemDetailsData.value.addons![index].totalConvertPrice,
                                                                              );
                                                                            }
                                                                            calculate();
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(right: 16.w, bottom: 16.h, top: 4.h),
                child: Container(
                  height: 48.h,
                  width: double.infinity,
                  decoration: BoxDecoration(
                    border: Border.all(width: 1.w, color: AppColor.itembg),
