...
// // lib/widget/favorite_heart_button.dart
// import 'package:flutter/material.dart';
// import 'package:get/get.dart';
...
class FavoriteHeartButton extends StatelessWidget {
  final int itemId;
  final double size;
  const FavoriteHeartButton({super.key, required this.itemId, this.size = 28});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<FavoritesController>(
      builder: (_) {
        final liked = fav.isFavorite(itemId);
        return InkWell(
          onTap: () => fav.toggle(itemId),
