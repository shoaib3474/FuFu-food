  ...
  Widget build(BuildContext context) {
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        const Spacer(),
                                        Icon(Icons.tune, color: Colors.red.shade400, size: 20),
                                      ],
                                    ),
                                  ),
                                ),
    ...
    transition: Transition.cupertino,
                                    ...
                                    child: CircleAvatar(
                                      backgroundColor: Colors.white,
                                      radius: 18,
                                      child: Icon(Icons.shopping_cart, color: Colors.red, size: 20),
                                    ),
                                  ),
                                  SizedBox(width: 8),
                                  CircleAvatar(
                                    ...
                                    child: InkWell(
                                        ...
                                        onTap: (){
                                          ...
                                          Get.to(
                                                  () => NotificationsPage(),
                                              transition: Transition.rightToLeft, // you can also use leftToRight
                                              duration: Duration(milliseconds: 300));
                                        }

                                        ,child: Icon(Icons.notifications, color: Colors.red, size: 20)),
                                  ),
                                  SizedBox(width: 8),
                                  InkWell(
                                    onTap: (){
