...
final fontRegularLiteWithCurrency = GoogleFonts.roboto(
  fontWeight: FontWeight.w400,
  fontSize: 14.sp,
);
...
final fontRegularBoldGreenWithCurrency = GoogleFonts.roboto(
  fontWeight: FontWeight.w400,
  color: AppColor.green,
  fontSize: 14.sp,
);
...
final fontMediumWithCurrency = GoogleFonts.roboto(
  fontWeight: FontWeight.w500,
  fontSize: Dimensions.fontSizeLarge.sp,
);
...
final fontMediumProWithCurrency = GoogleFonts.roboto(
  fontWeight: FontWeight.w500,
  fontSize: Dimensions.fontSizeDefault.sp,
);
